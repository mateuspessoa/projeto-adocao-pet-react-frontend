...
const PetForm = ({handleSubmit, petData, btnText}) => {
  ...
  return (
    <form onSubmit={submit} className="form_container">
        ...
        <Input text="Idade do Pet" type="number" name="age" placeholder="Digite a idade" handleOnChange={handleOnChange} value={pet.age || ''}/>

        <Input text="Peso do Pet" type="number" name="weight" placeholder="Digite o peso" handleOnChange={handleOnChange} value={pet.weight || ''}/>
